...
> Switched IDV for DLM caseum VPC to TIME instead of TAD (named as _v2)
> Switched IDV for RBT caseum VPC to TIME
> Switched IDV for RZL lung, cell, and caseum VPCs to TIME

########### FOR LZD and 223, NEED TO USE NATASHA'S ORIGINAL MODELS WITH LESIONS DIVIDED UP ############
...
## Run Cell VPCs
```{r}
#### need to re-run original drug and run list names first before code below can run
...
# :: Arrange plots
```{r}
# plasma plot #s match szd, szd-m1, 876, and 876-m3
...
# :: Arrange plots
```{r}
# plasma plot #s match bdq, bdq-m2, 587, and 587-m3
